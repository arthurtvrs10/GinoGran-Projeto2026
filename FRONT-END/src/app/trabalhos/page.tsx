    ...
    <div className="w-full bg-white min-h-screen pb-20">
      ...
      <section className="relative w-full h-[400px] flex items-center justify-center bg-gray-900 overflow-hidden">
        ...
        <div className="absolute inset-0 opacity-40">
          <Image
            src="https://images.unsplash.com/photo-1600607686527-6fb886090705?q=80&w=2000&auto=format&fit=crop" // Usei a do Unsplash ou coloque "/Marmore1.jpeg"
            ...
            {categories.map((cat) => (
              <button
                ...
                className={`px-6 py-2 rounded-full text-sm font-bold transition-all duration-300 border backdrop-blur-sm
                  ${
                    filter === cat
                      ? "bg-[#F9A825] text-white border-[#F9A825] shadow-lg scale-105" // Usei a cor dourada do seu tema (#F9A825)
