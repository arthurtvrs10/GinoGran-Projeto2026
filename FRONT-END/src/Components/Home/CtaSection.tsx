...
export default function CtaSection() {
  ...
  const baseButtonClass = "rounded-full py-3 px-8 font-bold transition-all duration-300 transform hover:scale-105";
  const primaryButtonClass = "bg-white text-black hover:bg-gray-200 shadow-lg";
  const outlineButtonClass = "border-2 border-white text-white bg-transparent hover:bg-white hover:text-black";
