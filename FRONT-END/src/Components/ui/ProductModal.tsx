      ...
      <div className="relative bg-white w-full max-w-4xl rounded-2xl shadow-2xl overflow-hidden flex flex-col md:flex-row animate-in fade-in zoom-in-95 duration-200">
        ...
        <div className="w-full md:w-1/2 p-8 flex flex-col justify-center">
          ...
          <p className="text-gray-600 mb-6 leading-relaxed">
            ...
            {product.description || "Uma escolha sofisticada para o seu projeto. Este material oferece durabilidade e uma estética atemporal, perfeita para ambientes internos e externos."}
          </p>
          ...
          <div className="flex flex-wrap gap-4 mb-8 text-sm text-gray-500">
            {product.color && (
              <div className="bg-gray-50 px-3 py-1 rounded-md border border-gray-100">
                Cor: <span className="text-gray-900 font-medium">{product.color}</span>
              </div>
            )}
            {product.finish && (
              <div className="bg-gray-50 px-3 py-1 rounded-md border border-gray-100">
                Acabamento: <span className="text-gray-900 font-medium">{product.finish}</span>
              </div>
            )}
          </div>
