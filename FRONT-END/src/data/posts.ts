...
export const posts: BlogPost[] = [
  {
    ...
    excerpt:
      "Descubra as principais diferenças de durabilidade e resistência para não errar na hora de reformar sua bancada.",
    content:
  ...
  },
  {
    ...
    excerpt:
      "Aprenda como limpar e manter o brilho da sua pedra natural por muito mais tempo com produtos simples.",
    content:
